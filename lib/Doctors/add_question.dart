...
class _add_questionState extends State<add_question> {
      ...
      body: StreamBuilder(
        ...
        builder: (BuildContext context, AsyncSnapshot<dynamic> snapshot) {
          if (!snapshot.hasData) {
            ...
            return FeedAddUI(doc['name'], doc['email'], doc['photo'],
                doc['locality'], doc['phone']);
          }
        },
      ),
    );
  ...
  FeedAddUI(name, email, Photo, location, phone) {
    return ListView(
      children: [
        Row(
          children: [
  ...
  void DialogBoxUpload(
      context, value, imageurl, userPhoto, name, phone, email) {
